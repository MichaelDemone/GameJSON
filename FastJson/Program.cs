...
";
        ...
        {
            DefaultReflectionTest();
            //StringReflectionTest();
            IntArrayReflectionTest();
            StructArrays();
            StructList();
            ClassArrays();
            ClassList();

            void DefaultReflectionTest() {
            ...
            void ClassArrays() {
                ...
                for(int i = 1; i < ts.Structs.Length; i++) {
